...
/**
 * Cell (клетка/ячейка) - этот класс описывает все клетки на шахматной доске.
 * У нас их фиксированное количество, поэтому здесь в качестве класса используется перечисление.
 */
public enum Cell {
